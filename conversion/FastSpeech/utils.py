...
def load_data(txt, mel, model):
    ...
    #print("mel_tacotron2",mel_tacotron2.shape, mel_tacotron2)
    #print("alignment",alignment.T.shape, alignment)
    #print("text_length",text_length)
    #plot_data((mel_tacotron2,alignment.T), txt[:10].replace(' ', ''))
